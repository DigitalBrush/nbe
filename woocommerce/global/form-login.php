...
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?>>
	...
	<p class="form-row form-row-first">
		<label for="username"><?php esc_html_e( 'Username or email', 'nbe' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="form-row">
		...
		<button type="submit" class="btn btn-outline-primary" name="login" value="<?php esc_attr_e( 'Login', 'nbe' ); ?>"><?php esc_html_e( 'Login', 'nbe' ); ?></button>
