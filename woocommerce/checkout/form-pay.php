	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'nbe' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'nbe' ); ?></th>
			</tr>
		</thead>
		<tbody>
